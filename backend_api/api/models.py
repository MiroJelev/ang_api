...
class Country(models.Model):
    ...
    area = models.FloatField(db_column='Area', blank=True, null=True)  # Field name made lowercase.
    population = models.IntegerField(db_column='Population', blank=True, null=True)  # Field name made lowercase.
    politics = models.ForeignKey(to='Politics', db_column='code', to_field="country", related_name='politics_country', on_delete=models.DO_NOTHING)
    continents = models.ForeignKey(to='Encompasses', db_column='code', to_field="country", related_name='continents_country', on_delete=models.DO_NOTHING)
